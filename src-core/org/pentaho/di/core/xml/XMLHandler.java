...
//		return addTagValue(tag, ""+l, cr);
    ...
    /**
	 * Build an XML string (including a carriage return) for a certain tag geometry (Geometry) value
	 * @param tag The XML tag
	 * @param val The geometry value of the tag
	 * @return The XML String for the tag.
	 */
    ...
    /**
	 * Build an XML string for a certain tag geometry (Geometry) value
	 * @param tag The XML tag
	 * @param val The geometry value of the tag
	 * @param cr true if a carriage return is desired after the ending tag.
	 * @return The XML String for the tag.
