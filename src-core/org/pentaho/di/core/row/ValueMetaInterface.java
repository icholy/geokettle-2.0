...
public interface ValueMetaInterface extends Cloneable
{
    ...
    public static final int TYPE_GEOMETRY    = 9;

    // public static final String[] typeCodes = new String[] { "-", "Number", "String", "Date", "Boolean", "Integer", "BigNumber", "Serializable", "Binary", };
    public static final String[] typeCodes = new String[] { "-", "Number", "String", "Date", "Boolean", "Integer", "BigNumber", "Serializable", "Binary", "Geometry"}; 
    // -- End GeoKettle modification --
     ...
     * @return true if the value is a Geometry
     */
