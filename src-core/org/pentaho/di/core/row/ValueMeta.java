...
public class ValueMeta implements ValueMetaInterface
{
    ...
    public ValueMeta clone()
    {
        try
        {
            ...
            // -- BEGIN GeoKettle modification --
            if (geometrySRS!=null) valueMeta.geometrySRS = (SRS) geometrySRS.clone();
            // -- END GeoKettle modification --
     ...
     * @param geometrySRS the new SRS to set
     */
    public void setGeometrySRS(SRS geometrySRS) {
    ...
    public Long getInteger(Object object) throws KettleValueException
    {
    	try
    	{
            ...
            // -- Begin GeoKettle modification --
	        case TYPE_GEOMETRY:
	            throw new KettleValueException(toString()+" : I don't know how to convert geometry values to integers.");
	        // -- End GeoKettle modification --            
	        default:
	            throw new KettleValueException(toString()+" : Unknown type "+type+" specified.");
	        }
    ...
    public Boolean getBoolean(Object object) throws KettleValueException
    {
        ...
        // -- Begin GeoKettle modification --
        case TYPE_GEOMETRY:
            throw new KettleValueException(toString()+" : I don't know how to convert geometry values to booleans.");
        // -- End GeoKettle modification --            
        default:
            throw new KettleValueException(toString()+" : Unknown type "+type+" specified.");
        }
    ...
    public Date getDate(Object object) throws KettleValueException
    {
        ...
        // -- Begin GeoKettle modification --
        case TYPE_GEOMETRY:
            throw new KettleValueException(toString()+" : I don't know how to convert a geometry value to date.");
        // -- End GeoKettle modification --
    ...
    public Geometry getGeometry(Object object) throws KettleValueException
    {
        ...
        case TYPE_BINARY:
            switch(storageType)
            {
            case STORAGE_TYPE_NORMAL:         return convertBinaryToGeometry((byte[])object);
            case STORAGE_TYPE_BINARY_STRING:  return convertBinaryToGeometry((byte[])object);
            case STORAGE_TYPE_INDEXED:        return convertBinaryToGeometry( (byte[]) index[((Integer)object).intValue()] );  
            default: throw new KettleValueException(toString()+" : Unknown storage type "+storageType+" specified.");
            }
        case TYPE_DATE:
        ...
        case TYPE_STRING:
            switch(storageType)
            {
            case STORAGE_TYPE_NORMAL:         return convertStringToGeometry((String)object);
            case STORAGE_TYPE_BINARY_STRING:  return convertStringToGeometry( (String)convertBinaryStringToNativeType((byte[])object) );
            case STORAGE_TYPE_INDEXED:        return convertStringToGeometry( (String) index[((Integer)object).intValue()] );
            default: throw new KettleValueException(toString()+" : Unknown storage type "+storageType+" specified.");
            }
        case TYPE_NUMBER:
     ...
     * @return true if this value is a Geometry
     */
    ...
    public Object readData(DataInputStream inputStream) throws KettleFileException, KettleEOFException, SocketTimeoutException
    {
        try
        {
            ...
            case STORAGE_TYPE_NORMAL:
                ...
                // -- Begin GeoKettle modification --
                case TYPE_GEOMETRY   : return readGeometry(inputStream);
                // -- End GeoKettle modification
            ...
            case STORAGE_TYPE_INDEXED:
	            {
	                ...
	                else
	                {
	                    ...
	                    for (int i=0;i<indexSize;i++)
	                    {
	                        ...
	                        // -- Begin GeoKettle modification --
	                        case TYPE_GEOMETRY:  index[i] = readGeometry(inputStream); break;
	                        // -- End GeoKettle modification --
        ...
        if (object!=null) // otherwise there is no point
        {
        	try {
	            ...
	            case STORAGE_TYPE_NORMAL:
	                ...
	                // -- Begin GeoKettle modification --
	                case TYPE_GEOMETRY   : xml.append( XMLHandler.addTagValue("geometry-value", (Geometry)object) ); break;
	                // -- End GeoKettle modification --
    ...
    public Object convertDataUsingConversionMetaData(Object data2) throws KettleValueException {
        ...
        // -- Begin GeoKettle modification --
        case TYPE_GEOMETRY  : return getGeometry(data2);
        // -- End GeoKettle modification --
        default: 
    ...
    public int hashCode(Object object) throws KettleValueException
    {
        ...
        if (isNull(object))
        {
            ...
            // -- Begin GeoKettle modification --
            // TODO: check this... is it the right thing to do?
        ...
        else
        {
            ...
            // -- Begin GeoKettle modification --
            // TODO: make sure hashCode() is correctly implemented for JTS Geometry
    ...
    /////////////////////////////////////////////////////////////////////////////
	// Spatial analysis functions (topological predicates) for geometry types: //
    /////////////////////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////
	// End of spatial analysis functions //
    ///////////////////////////////////////
