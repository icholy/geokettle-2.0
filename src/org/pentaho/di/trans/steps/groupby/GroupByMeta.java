...
public class GroupByMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	public static final int TYPE_GROUP_GIS_UNION		  = 15;
	public static final int TYPE_GROUP_GIS_COLLECT		  = 16;
	public static final int TYPE_GROUP_GIS_ENVELOPE		  = 17;
	...
	public static final String typeGroupCode[] =  /* WARNING: DO NOT TRANSLATE THIS. WE ARE SERIOUS, DON'T TRANSLATE! */ 
		{
			...
			// -- BEGIN GeoKettle modification --
			"GIS_UNION", "GIS_COLLECT", "GIS_ENVELOPE", //$NON-NLS-1$
			// -- END GeoKettle modification --
		};
	...
	public static final String typeGroupLongDesc[] = 
		{
            ...
            // -- BEGIN GeoKettle modification --
            Messages.getString("GroupByMeta.TypeGroupLongDesc.GIS_UNION"),  		//$NON-NLS-1$
            Messages.getString("GroupByMeta.TypeGroupLongDesc.GIS_COLLECT"),  		//$NON-NLS-1$
            Messages.getString("GroupByMeta.TypeGroupLongDesc.GIS_ENVELOPE"),  		//$NON-NLS-1$
            // -- END GeoKettle modification --
		};
