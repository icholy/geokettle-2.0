...
public class SRSTransformationMeta extends BaseStepMeta implements StepMetaInterface {
	...
	public void readRep(Repository rep, long id_step, List<DatabaseMeta> databases, Map<String, Counter> counters) throws KettleException {
		try {
			...
			throw new KettleException(Messages.getString("SRSTransformationMeta.Exception.UnexpectedErrorInReadingStepInfoFromRepository"), e); //$NON-NLS-1$
		}
	}
	...
	public void saveRep(Repository rep, long id_transformation, long id_step) throws KettleException {
		try {
			...
			throw new KettleException(Messages.getString("SRSTransformationMeta.Exception.UnableToSaveStepInfoToRepository")+id_step, e); //$NON-NLS-1$
		}
	}
